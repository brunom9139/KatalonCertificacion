...
WebUI.click(findTestObject('Object Repository/Make Appointment Button'))

// Fill in the username and password fields based on the variables
WebUI.setText(findTestObject('Object Repository/Username Field'), username)
WebUI.setText(findTestObject('Object Repository/Password Field'), password)

// Click the login button
WebUI.click(findTestObject('Object Repository/Login Button'))

// Verify that the appointment div exists
WebUI.verifyElementPresent(findTestObject('Object Repository/Appointment Div'))
